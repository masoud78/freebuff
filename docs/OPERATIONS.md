...
سرور هنگام شروع، پروکسی سیستم را به‌طور خودکار تشخیص می‌دهد و **تمام ترافیک خروجی** (ازجمله درخواست‌های Gemini) را از آن عبور می‌دهد:
...
وضعیت اعمال‌شده هنگام اجرای سرور در کنسول لاگ می‌شود (مثل `[proxy] enabled (windows-registry): http://127.0.0.1:12334`). این برای کاربرانی که در مناطق مسدود (مثلاً ایران) با VPN/پروکسی کار می‌کنند لازم است تا درخواست‌ها به Gemini برسند.
